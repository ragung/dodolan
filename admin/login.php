...
<div class="login-box">
  <div class="login-logo">
    <a href="admin/login.php"><b>W-</b>Bike</a>
  </div>
  <!-- /.login-logo -->
    ...
    <?php
      ...
      $cocok = $ambil->num_rows;
        if($cocok == 1){
         ...
         echo "<div class='alert alert-succes text-center'> Login Sukses Cuk </div>";
         echo "<meta http-equiv='refresh' content='1;url=index.php'>";
        } else {
          echo "<div class='alert alert-danger text-center'> Login Gagal Cuk </div>";
